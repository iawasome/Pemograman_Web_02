    ...
    public function show($id)
{
    ...
    {
    // Temukan data faskes berdasarkan ID
        $faskes = Faskes::findOrFail($id);

    // Update data faskes
        $updated = $faskes->update($request->all());
    ...
    // Cek apakah update berhasil
        ...
        return redirect()->back()->with('error', 'Data faskes gagal diperbarui. Silakan coba lagi.')->withInput();
        }
    }
    ...
    {
        $kabkotaId = $request->kabkota;
        $fasilitas = Faskes::where('kabkota_id', $kabkotaId)->get();
