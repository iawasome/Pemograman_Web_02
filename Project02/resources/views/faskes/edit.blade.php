                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('faskes.update', $faskes->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama', $faskes->nama) }}" required>
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="alamat" name="alamat" value="{{ old('alamat', $faskes->alamat) }}" required>
                            @error('alamat')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" id="website" name="website" value="{{ old('website', $faskes->website) }}">
                            @error('website')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $faskes->email) }}">
                            @error('email')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="rating" name="rating" value="{{ old('rating', $faskes->rating) }}" min="1" max="5">
                            @error('rating')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
